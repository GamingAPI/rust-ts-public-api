...
describe('v0/rust/servers/{server_id}/players/{steam_id}/events/gatheredResources can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    await testClient.publishToV0RustServersServerIdPlayersSteamIdEventsGatheredResources(publishMessage, ServerIdToSend, SteamIdToSend);
